...
intercept of .719 and a slope of .054. This indicates that the estimated mortality rates when poverty is 0 would be
...
cases which were fatal. The fit run on this data gives an intercept of 1.37 and a slope of .006. This means that the
...
density of counties which may have contributed to the rates of COVID exposure.
